...
function Collections() {
  return (
    <div className="my-20">
      ...
      <Marquee gradient gradientWidth={100} gradientColor="white" className="">
        <div
          className="flex items-center gap-3 border rounded-full border-gray-900 mx-2 p-2
      "
        >
          <img className="w-10 md:w-12" src={collImg} alt="" />
          <h3 className="text-lg md:text-xl font-medium">Landscape Painting</h3>
        </div>
        <div
          className="flex items-center gap-3 border rounded-full border-gray-900 mx-2 p-2
      "
      ...
      "
        >
          ...
          <h3 className="text-lg md:text-xl font-medium">Charcoal Sketching</h3>
        </div>
        <div
          className="flex items-center gap-3 border rounded-full border-gray-900 mx-2 p-2
      "
        >
          ...
          <h3 className="text-lg md:text-xl font-medium">Watercolour Painting</h3>
        </div>
        <div
          className="flex items-center gap-3 border rounded-full border-gray-900 mx-2 p-2
      "
