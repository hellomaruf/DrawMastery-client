  ...
  return (
    <div className="max-w-7xl mx-auto my-4 mt-24 lg:mt-36">
      ...
      <div data-aos="fade-down"
        data-aos-duration="1000" data-aos-delay="1000" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mx-6 lg:mx-3 gap-6">
        <Link
          to={`/category/Portrait Drawing`}
        ...
        <Link
          to={`/category/Watercolour Painting`}
          className="relative cursor-pointer"
        >
          <img
            className="rounded-xl border-4 border-gray-900"
        ...
        <Link
          to={`/category/Charcoal Sketching`}
          className="relative cursor-pointer"
        >
          <img
            className="rounded-xl border-4 border-gray-900"
        ...
        <Link
          to={`/category/Landscape Painting`}
          className="relative cursor-pointer"
        >
          <img
            className="rounded-xl border-4 border-gray-900"
