            ...
            <div className="collapse collapse-arrow join-item border border-base-300">
              ...
              <div className="collapse-content">
                <p>
                  ...
                  including mediums such as oil painting, watercolor, sculpture,
                  etc., as well as different styles like abstract, realism,
                  impressionism, etc.
                </p>
              </div>
            </div>
            <div className="collapse collapse-arrow join-item border border-base-300">
              ...
              <div className="collapse-content">
                <p>
                  ...
                  pieces and would like to inquire about commissioning an artist
                  for personalized artwork.
                </p>
              </div>
            </div>
            <div className="collapse collapse-arrow join-item border border-base-300">
